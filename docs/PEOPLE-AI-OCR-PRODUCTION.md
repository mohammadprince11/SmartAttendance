...
PaddleOCR 3.5.0, then executes the preflight below. PaddleOCR is intentionally
held at 3.5.0 while ZYNORA's extraction contract remains PP-OCRv5; upgrading
the OCR model/runtime is a separate regression-tested change.
...
5. PaddleOCR imports successfully;
6. CPU/GPU device selection is valid;
7. OCR models initialize successfully.
