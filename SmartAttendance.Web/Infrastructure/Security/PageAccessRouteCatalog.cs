...
public static class PageAccessRouteCatalog
{
    ...
    private static readonly IReadOnlyList<Route> Routes = new List<Route>
    {
        ...
        new("/attendanceimports", "Attendance.Operations"),
        new("/attendanceprocessing", "Attendance.Operations"),
        new("/attendancecorrections", "Attendance.Operations"),
        ...
        new("/payroll/payment", "Payroll.Payment"),
