...
"""),
        ...
        //    ⚠️ **مهجور — لا يُقرأ ولا يُكتب بعد الآن.** صار لنفس المعنى عمودان
        //    على نفس الجدول (`ArticleNo` تستشهد به الكتب الرسمية)، فدُمجا مرّةً
        //    واحدة بـ`DisciplinarySchema` وصارت الشاشتان على `ArticleNo`.
        //    العمود يبقى ولا يُحذف: إسقاطه بقاعدةٍ مشتركة فعلٌ لا رجعة فيه.
        //
