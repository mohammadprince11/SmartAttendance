...
CROSS JOIN (VALUES
    ...
    (N'Passport', N'IssueDate', N'تاريخ الإصدار', N'Optional', 90, CAST(1 AS bit)),
    (N'Passport', N'PlaceOfBirth', N'مكان الميلاد', N'Optional', 100, CAST(1 AS bit)),
    (N'Passport', N'MotherName', N'اسم الأم', N'Optional', 110, CAST(1 AS bit)),
    (N'Passport', N'IssuingAuthority', N'جهة الإصدار', N'Optional', 120, CAST(1 AS bit)),
