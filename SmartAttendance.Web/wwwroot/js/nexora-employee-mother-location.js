(function () {
    ...
    function refreshNexoraSelect(select) {
        if (!select) return;

        if (window.NexoraSelect &&
            typeof window.NexoraSelect.refresh === "function") {
            window.NexoraSelect.refresh(select);
        }
        else if (window.NexoraSelect &&
