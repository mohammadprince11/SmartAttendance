(function () {
    ...
    function bind() {
        ...
        if (!nationalitySelect.dataset.zynoraCountryNationalityExactBound) {
            nationalitySelect.dataset.zynoraCountryNationalityExactBound = "1";
        ...
        if (!countrySelect.dataset.zynoraCountryNationalityExactBound) {
            countrySelect.dataset.zynoraCountryNationalityExactBound = "1";
    ...
    window.ZynoraCountryNationality = {
        bind: bind,
