(() => {
    ...
    /* ZYNORA_CUTOFF_DELETE_MODAL_START */
    ...
    /* ZYNORA_CUTOFF_DELETE_MODAL_END */

    /* ZYNORA_SETUP_ENTITY_MODALS_START */
    ...
    /* ZYNORA_SETUP_ENTITY_MODALS_END */
    ...
    // سابقاً كان الموضع يُلتقط من `.zynora-content` ويُصفَّر تمرير المستند معه؛
...
/* ZYNORA_SEARCHABLE_SELECTS_START */
(() => {
...
/* ZYNORA_SEARCHABLE_SELECTS_END */

/* ZYNORA_SETUP_TABLE_PAGINATION_START */
(() => {
    const pageSize = 5;
    const tables = document.querySelectorAll(
        ".nx-company-setup-page .zynora-setup-table"
    );
    ...
    tables.forEach((table, tableIndex) => {
        ...
        const tableWrap = table.closest(".zynora-setup-table-wrap");
...
/* ZYNORA_SETUP_TABLE_PAGINATION_END */

/* ZYNORA_SETUP_SECTION_NAVIGATION_START */
(() => {
    "use strict";
    ...
    // القوقعة لا تصنع مُمرِّراً متداخلاً (zynora-global-scroll-system.css):
    ...
    function stickyTopbarOffset() {
        const topbar = document.querySelector(".zynora-topbar");
        const topbarHeight =
...
/* ZYNORA_SETUP_SECTION_NAVIGATION_END */
