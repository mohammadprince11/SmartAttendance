// ZYNORA Month Picker V1
// شقيق zynora-calendar-v18.js: يرقّي input[type="month"] لنفس الغلاف البصري (.nxcal)
...
// يعيد استخدام أصناف zynora-calendar-v18.css كما هي فلا CSS جديد.
// ZYNORA_MONTH_PICKER_V1_START

(() => {
    const SELECTOR = 'input[type="month"]:not([data-zynora-native-month="true"]):not([data-zynora-month-built="1"])';
    ...
    /* نظير `syncOpenState` بـzynora-calendar-v18.js — الشرح الكامل هناك. */
    ...
    function build(input) {
        if (!input || input.dataset.zynoraMonthBuilt === "1") return;

        input.dataset.zynoraMonthBuilt = "1";
        ...
        picker.dataset.zynoraMonthPickerVersion = "1";
