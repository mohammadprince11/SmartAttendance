// ZYNORA Calendar V18.8
// Canonical shared calendar with interactive month/year selection.
// ZYNORA_CALENDAR_PERIOD_SELECTOR_V18_8_START

(() => {
    const SELECTOR = 'input[type="date"]:not([data-zynora-native-date="true"]):not([data-zynora-calendar-built="1"])';
    ...
    /*
        راية لحظة الفتح. `zynora-calendar-v18.css` يفكّ قصّ أسلاف المنسدلة تحتها
    ...
    */
    ...
    function build(input) {
        if (!input || input.dataset.zynoraCalendarBuilt === "1") return;

        input.dataset.zynoraCalendarBuilt = "1";
        ...
        picker.dataset.zynoraCalendarVersion = "18.8";

        const button = document.createElement("button");
        button.type = "button";
        button.className = "nxcal__button";
        button.dataset.zynoraHover = "off";
...
function changeMonth(delta) {
        ...
        function render() {
            ...
            monthBtn.dataset.zynoraHover = "off";
            ...
            yearBtn.dataset.zynoraHover = "off";
            ...
            if (chooserMode === "month") {
                ...
                MONTHS_AR.forEach((monthName, monthIndex) => {
                    ...
                    option.dataset.zynoraHover = "off";
            ...
            if (chooserMode === "year") {
                ...
                previousRange.dataset.zynoraHover = "off";
                ...
                nextRange.dataset.zynoraHover = "off";
            ...
            panel.querySelectorAll("button").forEach((control) => {
                control.dataset.zynoraHover = "off";
            });
        }
    ...
    // ZYNORA_CALENDAR_INTERNAL_SCROLL_V18_6_START
    ...
    // ZYNORA_CALENDAR_INTERNAL_SCROLL_V18_6_END
...
// ZYNORA_CALENDAR_PERIOD_SELECTOR_V18_8_END
})();
