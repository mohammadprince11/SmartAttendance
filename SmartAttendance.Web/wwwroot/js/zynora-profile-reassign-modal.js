(function () {
    ...
    function refreshSelect(select) {
        ...
        } else if (window.ZynoraSelect && typeof window.ZynoraSelect.refreshAll === "function") {
    ...
    function openModal(event) {
        ...
        if (!modal) {
            console.warn("ZYNORA reassign modal was not found.");
            return;
        }
    ...
    window.ZYNORA_REASSIGN_MODAL_OPEN = openModal;
    window.ZYNORA_REASSIGN_MODAL_CLOSE = closeModal;
    window.ZYNORA_REASSIGN_MODAL_SYNC_ORG = syncOrganizationSelects;
})();